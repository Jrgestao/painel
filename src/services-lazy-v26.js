...
function loadBoardV25(replay = true) {
  if (!loaded.board) {
    ...
    loaded.board =
      import(
        './services-board-v26.js?v=observation-v26-20260807'
      )
        .then((module) => {
          const first =
            !boardReady
...
function loadHomeV25() {
  if (!loaded.home) {
    loaded.home =
      import(
        './services-home-overlay-v26.js?v=observation-v26-20260807'
      ).catch((error) => {
        loaded.home = null
...
function prepareModulesV25() {
  modulePreloadV25(
    './src/services-board-v26.js?v=observation-v26-20260807',
  )
  modulePreloadV25(
    './src/services-home-overlay-v26.js?v=observation-v26-20260807',
  )
  modulePreloadV25(
