...
} from './services-import-core-v24.mjs?v=24'
...
const state = {
  ...
  lastBoardRenderSignatureV24: '',
  boardWasRenderedV24: false,
}
...
function currentBoardRenderSignatureV24() {
...
function markBoardRenderedV24() {
  state.lastBoardRenderSignatureV24 =
    currentBoardRenderSignatureV24()

  state.boardWasRenderedV24 =
    Boolean(
      els.root &&
...
function bindEvents() {
  ...
  document.addEventListener('jr:monthdata', (event) => {
    ...
    if (cacheChanged) {
      ...
      state.lastBoardRenderSignatureV24 = ''
      state.boardWasRenderedV24 = false
    }
