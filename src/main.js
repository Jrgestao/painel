...
import { SUPABASE_URL, SUPABASE_PUBLISHABLE_KEY, INTERNAL_LOGIN_DOMAIN } from './config.js?v=3'
...
const els = {
  ...
  photosDateFilter: $('#photos-date-filter'), codesDateFilter: $('#codes-date-filter'), reportsDateFilter: $('#reports-date-filter'),
  photosRefreshButton: $('#photos-refresh-button'), codesRefreshButton: $('#codes-refresh-button'), reportsRefreshButton: $('#reports-refresh-button'),
...
function bindEvents() {
  ...
  els.monthFilter.addEventListener('change', () => loadDashboard())
...
function setLoading(value) {
  ...
  ;[els.refreshButton, els.photosRefreshButton, els.codesRefreshButton, els.reportsRefreshButton].forEach((button) => { if (button) button.disabled = value })
