...
function loadBoardV25(replay = true) {
  if (!loaded.board) {
    ...
    loaded.board =
      import(
        './services-board-v40-16-19.js?v=v40-16-19-20260902-observacoes-funcao-original'
      )
        .then((module) => {
          const first =
            !boardReady
...
function prepareModulesV25() {
  modulePreloadV25(
    './src/services-board-v40-16-19.js?v=v40-16-19-20260902-observacoes-funcao-original',
  )
  modulePreloadV25(
