...
const state = {
  ...
  afterMainFrameV23: 0,
  afterMainSecondFrameV23: 0,
  lastAppliedHomeSignatureV23: '',
}
...
function applyOverlay() {
  ...
  */
  ...
  state.lastAppliedHomeSignatureV23 =
    [
      state.settingsMonth,
      date,
      team,
...
function scheduleOverlayAfterMainV23() {
  cancelAnimationFrame(
    state.afterMainFrameV23,
  )
  cancelAnimationFrame(
    state.afterMainSecondFrameV23,
  )

  state.afterMainFrameV23 =
    requestAnimationFrame(() => {
      state.afterMainFrameV23 = 0

      state.afterMainSecondFrameV23 =
        requestAnimationFrame(() => {
          state.afterMainSecondFrameV23 = 0
          scheduleOverlay()
        })
    })
}

export function restoreHomeOverlayV23() {
  scheduleOverlayAfterMainV23()
}
