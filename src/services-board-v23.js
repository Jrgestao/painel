...
const state = {
  ...
  lastBoardRenderSignatureV23: '',
  boardWasRenderedV23: false,
}
...
function currentBoardRenderSignatureV23() {
...
function markBoardRenderedV23() {
  state.lastBoardRenderSignatureV23 =
    currentBoardRenderSignatureV23()

  state.boardWasRenderedV23 =
    Boolean(
      els.root &&
...
function bindEvents() {
  ...
  document.addEventListener('jr:monthdata', (event) => {
    ...
    if (cacheChanged) {
      ...
      state.lastBoardRenderSignatureV23 = ''
      state.boardWasRenderedV23 = false
    }
