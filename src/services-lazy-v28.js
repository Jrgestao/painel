...
function loadBoardV25(replay = true) {
  if (!loaded.board) {
    ...
    loaded.board =
      import(
        './services-board-v28.js?v=period-export-v28-20260807'
      )
        .then((module) => {
          const first =
            !boardReady
...
function loadHomeV25() {
  if (!loaded.home) {
    loaded.home =
      import(
        './services-home-overlay-v28.js?v=period-export-v28-20260807'
      ).catch((error) => {
        loaded.home = null
...
function prepareModulesV25() {
  ...
  modulePreloadV25(
    './src/services-home-overlay-v28.js?v=period-export-v28-20260807',
  )
  modulePreloadV25(
