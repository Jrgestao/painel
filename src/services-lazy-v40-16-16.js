...
function loadBoardV25(replay = true) {
  if (!loaded.board) {
    ...
    loaded.board =
      import(
        './services-board-v40-16-16.js?v=v40-16-16-20260902-matriz-atomica-pontuacao-fresca'
      )
        .then((module) => {
          const first =
            !boardReady
...
function prepareModulesV25() {
  modulePreloadV25(
    './src/services-board-v40-16-16.js?v=v40-16-16-20260902-matriz-atomica-pontuacao-fresca',
  )
  modulePreloadV25(
